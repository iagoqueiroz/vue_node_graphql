                ...
                <ul class="list-group">
                    <li class="list-group-item" v-for="item in items" v-bind:key="item.id">
                        <div class="row">
                            ...
                            <div class="col-md text-right">
                                <button class="btn btn-sm btn-danger" v-on:click="deleteItem(item)"><i class="fa fa-trash"></i></button>
                            </div>
                        </div>
                    </li>
                    <br>
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button class="btn btn-info" v-on:click="addItem(type, description)"><i class="fa fa-plus"></i></button>
                        </div>
                    </div>
                </ul>
            </div>
